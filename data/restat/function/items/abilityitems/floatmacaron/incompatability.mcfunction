tellraw @s[scores={ss.healthCompare=..10},tag=!ss.majorAbility] {"color":"dark_red","underlined":true,"text":"You don't have any more health to give! This item will do nothing! (you may die, too)"}
