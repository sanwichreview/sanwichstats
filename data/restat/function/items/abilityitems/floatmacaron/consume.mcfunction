...
execute as @s[scores={ss.health=..10},tag=!ss.ability.levitation] run damage @s 100000000000 magic by @s from @s
execute as @s[scores={ss.health=11..},tag=!ss.ability.levitation] run function restat:items/abilityitems/floatmacaron/statchange
