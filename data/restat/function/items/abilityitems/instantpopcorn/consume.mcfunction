...
execute as @s[scores={ss.health=..8},tag=!ss.ability.teleport] run damage @s 100000000000 magic by @s from @s
execute as @s[scores={ss.health=9..},tag=!ss.ability.teleport] run function restat:items/abilityitems/instantpopcorn/statchange
